...
web build:
 - http://mootools.net/more/4c632c779cd42de6f7bcccc2c35e8f92

packager build:
 - packager build More/Fx.Slide More/Fx.SmoothScroll
...
MooTools.More={version:"1.5.0",build:"73db5e24e6e9c5c87b3a27aebef2248053f7db37"};Fx.Slide=new Class({Extends:Fx,options:{mode:"vertical",wrapper:false,hideOverflow:true,resetHeight:false},initialize:function(b,a){b=this.element=this.subject=document.id(b);
